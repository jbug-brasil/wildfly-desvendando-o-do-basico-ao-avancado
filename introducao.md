...
Sendo destinado aos usuários do Brasil, só será disponibilizado em pt-BR.
  ...
  Os exemplos utilizados neste livro será publicado no **GitHub** neste link:  [https://github.com/jbug-brasil] (https://github.com/jbug-brasil). Caso encontre algum erro e/ou problema durante sua execução será de altíssima importância sua contribuíção para que possamos sempre melhorar o conteúdo oferecido.
